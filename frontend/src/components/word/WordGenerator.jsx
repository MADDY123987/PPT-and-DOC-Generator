            ...
            <div className="prompt-box">
              ...
              <div className="prompt-footer">
                ...
                <button
                  ...
                  onClick={() =>
                    setDocTopic(
                      "Create a comprehensive and well-structured document on the topic “Wonders of Nature.” Provide a deep and expressive explanation of how nature represents the beauty, balance, and life-supporting systems of our planet. Explore major natural elements such as forests, oceans, rivers, mountains, atmosphere, soil, and wildlife, explaining how each contributes to ecological stability and human wellbeing. Describe the diversity of plant and animal life, the role of natural cycles like seasons and climate patterns, and the way ecosystems remain interconnected and self-sustaining when undisturbed. Include thoughtful descriptions, simple real-world examples, and clear explanations of how these natural systems shape human life, culture, and survival. Discuss human impact such as pollution, deforestation, habitat destruction, overconsumption, and climate change, and explain how these actions weaken the natural balance. Finally, highlight meaningful and practical ways individuals, communities, and governments can protect and restore nature through conservation, sustainable development, awareness, and responsible behavior. The writing should be rich, smooth, descriptive, and suitable for expanding into multiple sections of a detailed Word document."
                    )
                  }
